...
-- CreateEnum
CREATE TYPE "IssueType" AS ENUM ('book', 'order', 'review', 'other');
...
CREATE TABLE "Order" (
    ...
    "paymentMethod" TEXT NOT NULL DEFAULT 'fake',
...
-- CreateIndex
CREATE INDEX "Book_featured_featuredOrder_idx" ON "Book"("featured", "featuredOrder");
